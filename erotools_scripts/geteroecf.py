...
parser.add_argument("--arf",type=str,default="onaxis",help="Path to the ARF file. Defaults to `onaxis`.")
parser.add_argument("--rmf",type=str,default="onaxis",help="Path to the RMF file. Defaults to `onaxis`.")
